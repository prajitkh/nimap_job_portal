...
public class SwaggerConfig {
	public static final String AUTHENTICATION_APPLICATION = "APNA JOB";
	...
	private List<SecurityReference> sf() {
		...
		return Arrays.asList(new SecurityReference("", new AuthorizationScope[] { scope }));
	}
	...
	private ApiInfo getInfo() {
		return new ApiInfo(AUTHENTICATION_APPLICATION, "", "", "", new Contact("", "", ""), "", "",
